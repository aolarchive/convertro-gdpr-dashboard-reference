# How to contribute to convertro-gdpr-dashboard-reference
...
**Please Note**: This project is a reference implementation, so while bug fixes and documentation improvements are absolutely appreciated, new features and improvements to the code are not likely.

## Code of Conduct

By participating in this project, you agree to abide by the [Contributor Covenant Code of Conduct](code-of-conduct.md). Everyone is welcome to submit a pull request or open an issue to improve the documentation, add improvements, or report bugs.
